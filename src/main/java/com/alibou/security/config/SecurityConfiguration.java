...
public class SecurityConfiguration {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    System.out.println("MANAGER_UPDATE.toString()-->"+ MANAGER_UPDATE.getPermission());
    http
        .csrf()
        .disable()
        ...
        .requestMatchers(DELETE, "/api/v1/management/**").hasAnyAuthority(ADMIN_DELETE.name(), MANAGER_DELETE.name())
            ...
            .requestMatchers(GET, "/api/v1/publications/**").permitAll()
            .requestMatchers(POST, "/api/v1/publications/**").permitAll()
            .requestMatchers(PUT, "/api/v1/publications/**").hasAuthority(MANAGER_UPDATE.getPermission())
            /*.hasAnyRole(MANAGER.name()) */
            .requestMatchers(DELETE, "/api/v1/publications/**").permitAll()
